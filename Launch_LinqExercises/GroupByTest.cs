namespace Launch_LinqExercises
{
    public class GroupByTest
    {
        ...
        public void GroupNumbersByOddAndEven()
        {
            ...
            var oddAndEven = numbers.GroupBy(n => n % 2).ToList();
        ...
        public void GroupWordsByFirstLetter()
        {
            ...
            var wordsByFirstLettter = words.GroupBy(w => w[0]).ToList();
        ...
        public void GroupWordsByUniqueness()
        {
            ...
            var grouped = words.GroupBy(w => w.ToLower()).ToList();
        ...
        public void GroupByNumberOfZeros()
        {
            ...
            var grouped = numbers.GroupBy(n => n.ToString().Count(c => c == '0')).ToList();
        ...
        public void GroupByOrderOfMagnitude()
        {
            ...
            var grouped = numbers.GroupBy(n => n.ToString().Length).ToList();
