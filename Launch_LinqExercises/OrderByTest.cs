...
namespace Launch_LinqExercises
{
    public class OrderByTest
    {
        ...
        public void SortByDistance()
        {
            ...
            //var sorted = distances.OrderBy(d => int.Parse(d.Substring(0, d.Length - 2))).ToList();
            var sorted = distances.OrderBy(d => int.Parse(d.Split("cm")[0])).ToList();
        ...
        public void SortByNumberOfCents()
        {
            ...
            var sorted = prices.OrderBy(p => p - Math.Floor(p)).ToList();
